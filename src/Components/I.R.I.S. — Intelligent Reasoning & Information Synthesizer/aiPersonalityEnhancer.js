...
// Kaomoji library for different emotions/situations
const KAOMOJI = {
  happy: ['(^▽^)', '(≧◡≦)', '(◕‿◕)', '(✿◠‿◠)', '(´｡• ᵕ •｡`)', 'ヽ(´▽`)/'],
  excited: ['＼(^o^)／', 'ヽ(°〇°)ﾉ', '＼(＾O＾)／', 'ヾ(^∇^)', '(*^▽^*)'],
  thinking: ['(´･_･`)', '(-_-?)', '(・_・ヾ', '(・・?)', '(-ω-;)'],
  confused: ['(・・)?', '(⊙_⊙)?', '(@_@)', '(◎_◎;)', 'ლ(ಠ_ಠლ)'],
  love: ['(♥ω♥)', '(˘︶˘)', '(⺣◡⺣)♡', '(◕‿◕)♡', '(｡♥‿♥｡)'],
  shy: ['(⁄ ⁄•⁄ω⁄•⁄ ⁄)', '(⺣﹏⺣)', '(,,>﹏<,,)', '(*ﾉωﾉ)'],
  sad: ['(╥﹏╥)', '(︶︹︺)', '(◞‸◟)', '(｡•́︿•̀｡)', '(T_T)'],
  angry: ['(╬ Ò﹏Ó)', '(ノಠ益ಠ)ノ', '(╯°□°)╯', '(ﾉ｀⌒´)ﾉ', '(；¬_¬)'],
  cool: ['(⌐■_■)', '(▀̿Ĺ̯▀̿ ̿)', 'ヾ(⌐■_■)ノ♪', '(•_•) ( •_•)>⌐■-■'],
  surprised: ['(ﾉﾟ0ﾟ)ﾉ', '(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧', '＼(°o°)／', '(@_@;)'],
  determined: ['(ง'̀-'́)ง', 'ᕦ(ò_óˇ)ᕤ', '(•̀ᴗ•́)و', '୧(﹒︠ᴗ﹒︡)୨'],
  sleepy: ['( ˘ω˘ )ｽﾔｧ', '(-_-) zzZ', '(−_−) zzZ', '(´～｀)'],
  dancing: ['ヽ(⌐■_■)ノ♪♬', '♪┏(・o･)┛♪', '♪(┌・。・)┌', '┌(ﾟдﾟ)┘'],
  shrug: ['¯\\_(ツ)_/¯', '┐(￣ヘ￣)┌', '╮(￣_￣)╭', '┐(´д`)┌'],
};
