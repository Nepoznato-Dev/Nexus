    ...
    switch (type) {
      ...
      case 'toggle': {
        ...
        if (!setting) {
          return {
            success: false,
            error: `I couldn't find a setting for "${settingText}". Try being more specific!`,
          };
        }
      ...
      case 'set': {
        ...
        if (!setting) {
          return {
            success: false,
            error: `I couldn't find a setting for "${settingText}"`,
          };
        }
      ...
      case 'decrease': {
        ...
        if (!setting) {
          return { success: false, error: `Couldn't find "${settingText}"` };
        }
      ...
      case 'list': {
        ...
        return {
          success: true,
          message: `Here are your ${category} settings:`,
      ...
      case 'reset': {
        ...
        return {
          ...
          message: result.message || `🔄 Reset ${category} settings`,
        };
      }
